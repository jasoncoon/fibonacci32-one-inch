...
Adafruit_FreeTouch touch1 = Adafruit_FreeTouch(A3, OVERSAMPLE_4, RESISTOR_0, FREQ_MODE_NONE);
...
uint16_t touchMin[touchPointCount] = { 467, 170, 220, 264 };
...
uint8_t touchPointX[touchPointCount] = { 128, 0, 128, 255 };
uint8_t touchPointY[touchPointCount] = { 0, 128, 255, 128 };
